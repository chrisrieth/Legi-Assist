...
Notably, and different than other speed cameras in use in the State, if SHA or its contractor 
moves or places a safety corridor speed monitoring system to or at a safety corridor where 
a system had not previously been moved or placed within the previous year, SHA must 
mail a warning notice instead of a citation for a recorded violation during the first 90 days 
