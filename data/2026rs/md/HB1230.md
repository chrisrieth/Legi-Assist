...
5 Office of Supplier Diversity and Inclusion; ~~authorizing~~ requiring the Commission to
6 name the Office; altering the purpose and duties of the Office; altering the local small
7 business enterprise program to ~~include~~ ~~local~~ ~~or~~ ~~small~~ ~~businesses~~ ~~or~~ ~~certain~~ ~~other~~
8 ~~businesses~~ be the business participation program and limiting participation in the
9 program to certain businesses; requiring the Commission to adopt certain additional
10 eligibility criteria for participation in the program; authorizing the Commission to
...
27 OBJECTIVES BUSINESSES ELIGIBLE TO PARTICIPATE IN THE PROGRAM by:
